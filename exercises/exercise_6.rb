...
@store5 = Store.find(id = 5)
@store4 = Store.find(id = 4)

@store1.employees.create(first_name: 'Khurram', last_name: 'Virani', hourly_rate: 60)
@store1.employees.create(first_name: 'Selin', last_name: 'Huang', hourly_rate: 50)
@store2.employees.create(first_name: 'Tyler', last_name: 'Caceres', hourly_rate: 40)
@store5.employees.create(first_name: 'JJ', last_name: 'Ting', hourly_rate: 1)
@store4.employees.create(first_name: 'V', last_name: 'Tranduc', hourly_rate: 2)
